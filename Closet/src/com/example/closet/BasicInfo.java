...
public class BasicInfo {
     ...
     * 사진 저장 위치
     */
    public static String FOLDER_PHOTO       = "data/closet/";
 
    /**
     * 동영상 저장 위치
     */
    public static String FOLDER_VIDEO       = "Closet/video/";
 
    /**
     * 녹음 저장 위치
     */
    public static String FOLDER_VOICE       = "Closet/voice/";
 
    /**
     * 손글씨 저장 위치
     */
    public static String FOLDER_HANDWRITING     = "Closet/handwriting/";
     ...
     * 데이터베이스 이름
     */
    public static String DATABASE_NAME = "Closet/items.db";
    ...
    public static final int CONFIRM_NO_PHOTO = 3003;
}